...
public class Main {
    ...
    public static void main(String[] args) {
        boolean flag = false;
        SuperMarket sm = new SuperMarket(true);
        ...
        while(true){
            ...
            System.out.println("5. Canviar a "+(sm.modern ? "Random SuperMarket" : "Modern SuperMarket"));
            while(sc.hasNext()){
                if(sc.hasNextInt()){
                    ...
                    switch( accio ){
                        ...
                        case 5:
                            if(sm.modern){
                                sm.changeRouter(false);
                            }else{
                                sm.changeRouter(true);
                            }
                            break;
                    }
                }else{
